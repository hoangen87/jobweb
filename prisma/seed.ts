    ...
    await prisma.job.createMany({
      data: [
        ...
        },
        {
          ...
          benefits:
            "Thu nhập cạnh tranh, xét tăng lương hàng năm, chế độ phúc lợi đầy đủ theo luật định.",
          status: "OPEN",
        },
        {
          ...
          requirements:
            "Không yêu cầu kinh nghiệm, được đào tạo tại chỗ. Chăm chỉ, chịu được áp lực công việc theo ca.",
          benefits:
            "Lương cơ bản + phụ cấp chuyên cần + tăng ca, hỗ trợ chỗ ở, ăn ca miễn phí.",
          status: "OPEN",
        },
      ],
    });
